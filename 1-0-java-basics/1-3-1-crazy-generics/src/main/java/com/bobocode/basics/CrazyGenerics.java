...
public class CrazyGenerics {
     ...
     */
    interface ComparableCollection<E extends List<E>> extends Collection<E>, Comparable<E> {// todo: refactor it to make generic and provide a default impl of compareTo
